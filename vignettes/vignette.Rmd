...
```{r echo=TRUE, message=FALSE, warning=FALSE, tidy=TRUE, cache=FALSE, comment="", dev='png', out.width = "800px", out.height = "662px", fig.width = 11, fig.height = 8, dpi = 500, fig.align="center"}
...
```{r echo=TRUE, message=FALSE, warning=FALSE, tidy=TRUE, cache=FALSE, comment="", dev='png',  out.width = "800px", out.height = "620px", fig.width = 11, fig.height = 8, dpi = 500, fig.align="center"}


plt <- scatterHatch(data = pdacData, x = "Xt", y = "Yt", 
    color_by = "frame", pointSize = 0.5, legendTitle = "Frame")
plot(plt)
```
