...
#' Draws the positive diagnol pattern
#'
#' Using the 2D frequency matrix from countGridPoints(), this function goes diagnol by diagnol
...
#' @param density Density of the pattern to be drawn.  Must be 1 or less.  Skips drawing the pattern every n diagnols.
